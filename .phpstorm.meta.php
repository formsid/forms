...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Actions\Contracts\GenerateOTPContract' => \App\Actions\GenerateOTP::class,
            'App\Actions\Contracts\OTPGeneratorContract' => \App\Objects\OTPGenerator::class,
            'App\Actions\Contracts\RememberOTPContract' => \App\Actions\RememberOTP::class,
            'App\Actions\Contracts\SendOTPNotificationContract' => \App\Actions\SendOTPNotification::class,
